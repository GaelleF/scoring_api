...
#import models_pkl
# "SK_ID_CURR":100001.0,
data_test = [{"NAME_CONTRACT_TYPE":0.0,"CODE_GENDER":0.0,"FLAG_OWN_CAR":0.0,
...
"ORGANIZATION_TYPE_Agriculture":0.0,"ORGANIZATION_TYPE_Business_Entity":0.0,
...
def model_predict(payload):
  ...
  exp_light = explainer_light.explain_instance(pd.Series(data),
